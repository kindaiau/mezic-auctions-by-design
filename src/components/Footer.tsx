      ...
      <div className="mx-auto max-w-6xl px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="w-16 h-16 rounded-full bg-[hsl(349,100%,83%)] hover:bg-[hsl(349,100%,80%)] shadow-lg hover:shadow-xl flex flex-col items-center justify-center gap-0.5 transition-all duration-300 hover:scale-105 border-2 border-[hsl(358,85%,52%)]"
            aria-label="Follow on Instagram"
          >
            <svg
              aria-hidden="true"
              viewBox="0 0 24 24"
              className="h-4 w-4 fill-current text-[hsl(358,85%,52%)]"
            >
            ...
            <span className="text-[hsl(358,85%,52%)] font-black text-[8px] leading-none">INSTA</span>
          </a>
          <a
          ...
          >
            ...
            <span className="text-[hsl(358,85%,52%)] font-black text-[8px] leading-none">FACE</span>
          </a>
        </div>
      </div>
    </footer>
